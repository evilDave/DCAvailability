...
#define DC_AVAILABILITY_10_1(_ios) CF_AVAILABLE_IOS(_ios)
#define DC_AVAILABILITY_10_2(_ios) CF_AVAILABLE_IOS(_ios)
#define DC_AVAILABILITY_10_3(_ios) CF_AVAILABLE_IOS(_ios)
#define DC_AVAILABILITY_11_0(_ios) CF_AVAILABLE_IOS(_ios)
...
#if __IPHONE_10_1 > __IPHONE_OS_VERSION_MIN_REQUIRED & __IPHONE_10_1 <= __IPHONE_OS_VERSION_MAX_ALLOWED
#undef  __AVAILABILITY_INTERNAL__IPHONE_10_1
#define __AVAILABILITY_INTERNAL__IPHONE_10_1 DC_DEPRECATED_NEWAPI(10_1)
#undef DC_AVAILABILITY_10_1
#define DC_AVAILABILITY_10_1(_ios) DC_DEPRECATED_NEWAPI(_ios)
#endif

#if __IPHONE_10_2 > __IPHONE_OS_VERSION_MIN_REQUIRED & __IPHONE_10_2 <= __IPHONE_OS_VERSION_MAX_ALLOWED
#undef  __AVAILABILITY_INTERNAL__IPHONE_10_2
#define __AVAILABILITY_INTERNAL__IPHONE_10_2 DC_DEPRECATED_NEWAPI(10_2)
#undef DC_AVAILABILITY_10_2
#define DC_AVAILABILITY_10_2(_ios) DC_DEPRECATED_NEWAPI(_ios)
#endif

#if __IPHONE_10_3 > __IPHONE_OS_VERSION_MIN_REQUIRED & __IPHONE_10_3 <= __IPHONE_OS_VERSION_MAX_ALLOWED
#undef  __AVAILABILITY_INTERNAL__IPHONE_10_3
#define __AVAILABILITY_INTERNAL__IPHONE_10_3 DC_DEPRECATED_NEWAPI(10_3)
#undef DC_AVAILABILITY_10_3
#define DC_AVAILABILITY_10_3(_ios) DC_DEPRECATED_NEWAPI(_ios)
#endif

#if __IPHONE_11_0 > __IPHONE_OS_VERSION_MIN_REQUIRED & __IPHONE_11_0 <= __IPHONE_OS_VERSION_MAX_ALLOWED
#undef  __AVAILABILITY_INTERNAL__IPHONE_11_0
#define __AVAILABILITY_INTERNAL__IPHONE_11_0 DC_DEPRECATED_NEWAPI(11_0)
#undef DC_AVAILABILITY_11_0
#define DC_AVAILABILITY_11_0(_ios) DC_DEPRECATED_NEWAPI(_ios)
#endif
